...
public class TurretItem extends ItemTurret {
	@FunctionalInterface
	public interface onLoad {
		void call();
	}
	public TurretItem(String name) {
		super(name);
		hasLiquids = true;
		hasPower = true;
		hasItems = true;
	...
	public class TurretPowerBuild extends ItemTurretBuild {
		public RenderTurret render = TurretItem.this.render.copy();
		@Override
