...
public class T1Turret extends LayerProvider {
	...
	//dps 600+-0.35x range 36 power 780
	...
	public void run() {
		...
		//超导电磁炮
		{
			...
			超导电磁炮.ammoTypes.put(Items.metaglass, bullets.弹药_穿甲弹
				.build(items.纳米碳管, 50, 0.3f, 1f)
				.multiplier(items.纳米碳管, 600 + 0.35f * items.超导体.damage)
				.frag(bullets.弹片_狙击, items.金元素, 8, 0.15f, 13f, 0.5f)
				.bullet());
			超导电磁炮.ammoTypes.put(Items.surgeAlloy, bullets.弹药_穿甲弹
				.build(items.金元素, 50, 0.3f, 1f)
				.multiplier(items.金元素, 600 + 0.35f * 1200)
				.frag(bullets.弹片_狙击, items.金元素, 8, 0.15f, 13f, 0.5f)
				.bullet());
			preset.inject(超导电磁炮);
		}
		//毒刺导弹
		{
			...
			毒刺导弹.ammoTypes.put(Items.silicon, bullets.弹药_导弹
				...
				.multiplier(items.水元素, 150 + 0.85f * 300)
			...
			毒刺导弹.ammoTypes.put(Items.blastCompound, bullets.弹药_导弹
				...
				.multiplier(items.火元素, 150 + 0.85f * 650)
				.frag(bullets.弹片_爆炸, items.金元素, 1, 0.85f, 13f, 0.5f)
				.bullet());
			preset.inject(毒刺导弹);
		}
